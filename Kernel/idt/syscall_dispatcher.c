...
typedef int64_t (*syscall)(int64_t rdi, int64_t rsi, int64_t rdx, int64_t rcx,
						   int64_t r8);

static syscall syscall_functions[] = {(syscall) sys_read,
									  (syscall) sys_write,
...
int64_t syscall_dispatcher(int64_t rdi, int64_t rsi, int64_t rdx, int64_t rcx,
						   int64_t r8, int64_t rax) {
